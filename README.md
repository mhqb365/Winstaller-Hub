...
### Tiện ích
- **Xem thông tin**: Xem thông tin máy tính, độ chai pin, thông tin ổ cứng
- **Kích hoạt bản quyền**: Công cụ kích của Microsoft và massgrave.dev
- **Cleanup**: Dọn dẹp RAM, dọn dẹp file tạm, dọn dẹp ổ đĩa hệ thống
- **Drivers**: Sao lưu và khôi phục các driver trên máy tính
- **Data**: Sao lưu và khôi phục các folder dữ liệu
- **System**: Các công cụ hệ thống
